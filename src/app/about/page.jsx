    ...
    <div className={styles.container}>
      <div className={styles.textContainer}>
        ...
        <p className={styles.description}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum vitae sequi corrupti cupiditate eos iste
          ipsam voluptatum hic incidunt. Perspiciatis eveniet similique reprehenderit voluptas doloribus est dolorem
          iure voluptatem nulla.
        </p>
